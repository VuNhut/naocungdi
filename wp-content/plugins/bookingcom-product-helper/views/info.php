			...
			<li class="description-list__item">
				...
				<p class="list-item__text">
					...
					echo sprintf(
						...
						'<a href="" target="_blank" class="list-item__text--link">Affiliate Partner Centre</a>',
						'<a href="" target="_blank" class="list-item__text--link">Affiliate Partner Programme</a>'
					);
					?>
				</p>
				<p class="list-item__secondary-text">
					<a href="" target="_blank" class="list-item__text--link">
						<?php
						echo esc_html__(
