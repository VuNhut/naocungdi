...
?>
	...
	<div class="row footer-widget-area">
		...
		<div class="col-sm-8 col-md-5 footer-widget" role="complementary">
			<?php dynamic_sidebar( 'footer-widget-2' ); ?>
		</div><!-- .widget-area .second -->
		<?php endif; ?>

		<?php if ( is_active_sidebar( 'footer-widget-3' ) ) : ?>
		<div class="col-sm-8 col-md-4 push-xs-0 push-sm-4 push-md-0 footer-widget" role="complementary">
