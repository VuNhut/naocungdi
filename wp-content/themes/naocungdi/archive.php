...
get_header(); ?>
		...
		<section id="primary" class="content-area col-sm-12 <?php echo of_get_option( 'site_layout' ); ?>">
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php if (is_category(array('du-an', 'khu-dan-cu', 'can-ho', 'khu-thuong-mai-cho-thue', 'dang-trien-khai', 'da-hoan-thanh'))) { ?>
				<?php
					// global $wp_query;
				...
				<?php } elseif (is_category(array('thu-vien', 'hinh-anh', 'video'))) { ?>
					<p class="type-library moveRight-500 duration-1000 delay-800 hidden"><span><a href="<?php echo home_url(); ?>/thu-vien/hinh-anh" class="<?php if (is_category('hinh-anh')) { echo 'active'; } ?>">Hình ảnh</a></span><span><a href="<?php echo home_url(); ?>/thu-vien/video" class="<?php if (is_category('video')) { echo 'active'; } ?>">Video</a></span></p>
