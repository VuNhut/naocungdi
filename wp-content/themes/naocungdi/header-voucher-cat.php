                ...
                <div class="multiple-slides">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <?php endif; ?>
                            <?php if($queryTransport->have_posts()) : ?>
                            <div class="swiper-slide">
                            ...
                            <?php endif; ?>
                            <?php if($queryAirport->have_posts()) : ?>
                            <div class="swiper-slide">
...
<section class="list-ticket cat-list">
    <div class="container">
        <?php echo the_breadcrumb(); ?>
    </div>
    <div class="container">
        <div class="row list-voucher">
            <?php while ($queryCat->have_posts()) : $queryCat->the_post(); $info_product = rwmb_meta('chi-tiet-ve'); ?>
            <div class="col-lg-3 col-md-4 col-sm-6 one-voucher">
...
<section class="list-ticket cat-list">
    <div class="container">
        <div class="row">
            <?php echo the_breadcrumb(); ?>
            <p class="col-xs-12 no-post">Hiện tại chưa có dịch vụ <strong><?php single_cat_title(); ?></strong><?php echo ($des ? " tại " . $des->name : ""); ?></p>
        </div>
    </div>
</section>
